...
abstract class Kohana_Mail_Sender {
	 ...
	 *
	 * @param string $name
	 *        	name of the Mail_Sender object to instanciate.
	 * @param array $options
	 ...
	 *
	 * @param variant $receivers
	 *        	an email, list of email or associative array of email to name.
